        ...
        (define (problem shakey-piano)
          ...
          (:init
            ...
            ;The connections between octaves in terms of note doors and chord doors.
            ...
            ;are to be picked up by Shakey.


            (note noteC1) (at-floor noteC1) (in noteC1 buffer)
            (note noteE1) (at-floor noteE1) (in noteE1 buffer)
            (note noteA1) (at-floor noteA1) (in noteA1 buffer)
            (note noteD1) (at-floor noteD1) (in noteD1 buffer)
            (note noteG1) (at-floor noteG1) (in noteG1 buffer)
          ...
          (:goal
            (and
              ...
              (at-piano noteC1) (in noteC1 octave0)
              (at-piano noteC1) (in noteC1 octave1)
              (at-piano noteD1) (in noteD1 octave0)
              (at-piano noteE1) (in noteE1 octave1)
              (at-piano noteA1) (in noteA1 octave1)
              (at-piano noteG1) (in noteG1 octave1)
