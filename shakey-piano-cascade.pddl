        ...
        (define (problem shakey-piano)
          ...
          (:init
            ...
            ; FROM SHAKEYS-PIANO.PDDL BY
            ;***** CHANGING THIS ONE SINGLE NOTE E TO OCTAVE1 IN THIS INITIAL STATE HAS CASCADING
            ;EFFECTS ACROSS THE WHOLE ROUTE PLAN. THIS PROPERTY OF THE SYSTEM CASCADING CAN BE
            ; USED TO DEMONSTRATE HOW CREATIVE PDDL CAN BE IN EASILY GENERATING VASTLY DIFFERENT IDEAS -
            ; OF SPECIFIC ROUTES 
            (note noteE) (at-floor noteE) (in noteE octave1)
